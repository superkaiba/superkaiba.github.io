...
In my [newest paper](https://thomas.jiralerspong.com/assets/docs/affine-anticipation.pdf), we find a linear map from context to answer representations. Some directions to build on this:
